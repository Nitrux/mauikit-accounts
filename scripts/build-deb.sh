...
checkinstall -D -y \
	...
	--requires="libc6,libqt6core6t64,libqt6qml6,libqt6sql6,mauikit-git \(\>= 4.0.1+git\),qml6-module-org-kde-kirigami,qml6-module-qtquick-controls,qml6-module-qtquick-shapes" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
